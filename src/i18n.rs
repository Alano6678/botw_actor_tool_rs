...
pub fn tr(lang: UiLang, key: &str) -> &str {
    ...
    match key {
        ...
        "Open Vanilla Actor (Wii U)\tCtrl+N" => "打开原始 Actor（Wii U）\tCtrl+N",
        "Open Vanilla Actor (Switch)\tCtrl+Shift+N" => "打开原始 Actor（Switch）\tCtrl+Shift+N",
        ...
        // Settings panel
        "Game Directory" => "游戏目录",
        "Switch Game Directory" => "Switch 游戏目录",
        "Update Directory" => "更新目录",
        "Switch Update Directory" => "Switch 更新目录",
        "DLC Directory" => "DLC 目录",
        "Switch DLC Directory" => "Switch DLC 目录",
        "Browse…" => "浏览…",
        "Language" => "文本语言",
        "UI Language" => "界面语言",
        "Dark Mode" => "深色模式",
